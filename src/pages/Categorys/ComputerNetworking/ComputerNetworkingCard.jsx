...
const ComputerNetworkingCard = ({ products }) => {
    const { _id, productImg, productName, productBrand, productDescription, productPrice, productRating } = products
    return (
...
ComputerNetworkingCard.propTypes ={
    products:PropTypes.object
}

export default ComputerNetworkingCard;